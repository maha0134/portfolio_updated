        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <a
              ...
              className="px-8 py-4 bg-white text-gray-800 rounded-lg font-semibold text-lg shadow-lg hover:shadow-xl border-2 border-gray-200 hover:border-blue-600 transform hover:-translate-y-1 transition-all duration-200 w-full sm:w-auto"
            >
              Get In Touch
            </a>
          </div>
          ...
          <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-8 max-w-3xl mx-auto">
            ...
            <div className="text-center">
              ...
              <div className="text-gray-600 text-sm">Coffee Consumed</div>
            </div>
          </div>
