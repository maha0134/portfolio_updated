          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {skills.map((skillGroup, index) => (
              <div key={index} className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-6 pb-3 border-b-2 border-blue-600">
                  {skillGroup.category}
                </h4>
        ...
        <div className="mt-16 max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-6 bg-blue-50 dark:bg-gray-800 rounded-xl">
              ...
              <h4 className="font-bold text-gray-900 dark:text-white mb-2">Focus</h4>
              <p className="text-gray-600 dark:text-gray-400 text-sm">User-centric design and performance optimization</p>
            </div>
            <div className="text-center p-6 bg-purple-50 dark:bg-gray-800 rounded-xl">
              <div className="text-4xl mb-3">🚀</div>
              <h4 className="font-bold text-gray-900 dark:text-white mb-2">Approach</h4>
              <p className="text-gray-600 dark:text-gray-400 text-sm">Agile development with continuous learning</p>
            </div>
            <div className="text-center p-6 bg-cyan-50 dark:bg-gray-800 rounded-xl">
              <div className="text-4xl mb-3">💡</div>
              <h4 className="font-bold text-gray-900 dark:text-white mb-2">Philosophy</h4>
              <p className="text-gray-600 dark:text-gray-400 text-sm">Clean code, best practices, and innovation</p>
            </div>
          </div>
        </div>
      </div>
